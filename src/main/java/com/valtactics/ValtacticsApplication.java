...
public class ValtacticsApplication {
    private static final Logger logger = LoggerFactory.getLogger(ValtacticsApplication.class);

    public static void main(String[] args) {
	   SpringApplication.run(ValtacticsApplication.class, args);
    }
